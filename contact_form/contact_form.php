...
// configure
$from = 'truongdaihairung@gmail.com'; // Replace it with Your Hosting Admin email. REQUIRED!
$sendTo = 'rung.iuh@gmail.com'; // Replace it with Your email. REQUIRED!
...
if(isset($_POST['g-recaptcha-response']) && !empty($_POST['g-recaptcha-response'])):
    ...
    $secret = '6Ld9OUIkAAAAAElwv2vyxy7b6AmXzrSumHoyrJ-N';
